...
endmodule //altio_iobuf_bidir_oto
//VALID FILE
...
module altio (
	...
	altio_iobuf_bidir_oto	altio_iobuf_bidir_oto_component (
				.datain (datain),
				.oe (oe),
				.dataio (dataio),
				.dataout (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altio.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altio.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altio.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altio.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altio_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altio_bb.v FALSE
